...
-(NSArray *)tiles {
    ...
    tile1.story = @"Captain we need a fearless leader such as yourself to undertake a voyage. You have to stop the evil pirate Boss. Would you like a blunted sword to get started?";
    ...
    tile3.story = @"A mysterious dock appears on the horizon. Shoulf we stop and ask for direction?";
    ...
    tile6.story = @"You have been captured by pirates and are order to walk the plank";
    ...
    tile7.actionButtonName = @"Fight those guys";
